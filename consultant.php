...
<div class="page-container sidebar-collapsed" style="padding-left: 0%;">
        ...
        <div class="row">
            <div id="exTab1" class="">
                <ul  class="nav nav-pills">
                    <li class="active">
                        <a  href="#all_application_tab_content" data-toggle="tab">In Process Applications</a>
                    </li>
                    <li>
                        <a href="#report_submission_sr_tab_content" data-toggle="tab">Report Submission - SR</a>
                    </li>
                    <li>
                        <a href="#report_submission_progress_tab_content" data-toggle="tab">Report Submission - Progress</a>
                    </li>
                    <li>
                        <a href="#approved_applications_tab_content" data-toggle="tab">Approved Applications</a>
                    </li>
                </ul>
                ...
                <div class="tab-content clearfix" style="max-height: 200px; min-height: 200px; overflow: auto;">
                    ...
                    <div class="tab-pane" id="report_submission_sr_tab_content">
                        <h1>Report Submission - SR</h1>
                    </div>
                    <div class="tab-pane" id="report_submission_progress_tab_content">
                        <h1>Report Submission - Progress</h1>
                    </div>
                    <div class="tab-pane" id="approved_applications_tab_content">
        ...
        <div class="row" style="max-height: 300px; margin-top: 2%;">
            ...
            <div class="col-lg-8" style="max-height: 300px; overflow: auto;">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="form-group" id="requirements_epd_users">
                            <textarea class="form-control" rows="7" id="epd_user_requirements" name="epd_user_requirements" placeholder="Documents/information requirements sent from EPD..."></textarea>
                        </div>
                        <div class="form-group" id="consultatn_comments">
                            <textarea class="form-control" rows="7" id="consultatn_comment_area" name="consultatn_comment_area" placeholder="Comments from Consultant..."></textarea>
                        </div>
                        <div>
                            <form id="form" action="includes/php/upload-image-ajax.php" method="post" enctype="multipart/form-data">
                                ...
                                <input class="col-lg-4 btn btn-info" id="button" type="submit" value="Upload Document" style="padding: 1%; margin-left: 2%;">
                            </form>
                        </div>
                    </div>
                </div>
