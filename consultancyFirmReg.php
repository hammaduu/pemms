    ...
    <div class="main-content" style="background-color: #91e291;">
        ...
        <div class="col-lg-12">
            <form class="registrationForm" id="consultant_firm_reg_form" style="color: blueviolet; font-family: sans-serif; font-weight: bold;">
                ...
                <div class="form-group">
                    <label for="consultancy_firm_username">Username:</label>
                    <input type="text" class="form-control" id="consultancy_firm_username" name="consultancy_firm_username" placeholder="Enter PEC Registration Number">
                </div>
                <div class="form-group">
